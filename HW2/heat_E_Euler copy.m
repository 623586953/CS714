...
for i = 1:length(N_list)
    ...
    % time step
    dt = a*h^2;       % choose a good time step (for stability)
    r = dt^2/(h^2);
    % indixes
    I = 2:N;
    % initial condition
    ...
    if i == 1
        ...
        interp_exactU = interp2(exact_X,exact_Y,exact_U,X,Y);
        error_list(i-1) = norm(U-interp_exactU,inf);
    end
end
